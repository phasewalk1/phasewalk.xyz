...
KaTeX is licensed under the [MIT
License](http://opensource.org/licenses/MIT). static/katex in this
theme (brutalist-minimalist) integrates katex directly into the theme,
according to the instructions at https://katex.org/docs/browser.html.

The original katex README is below, but note that we have only copied
the necessary files
https://github.com/KaTeX/KaTeX/releases/tag/v0.15.2 into static/katex.
